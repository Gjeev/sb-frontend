...
export default function App() {
  ...
  //         description:
  //           "Click on the search result to automatically move to your location.",
  //         position: "bottom",
  //       },
  //     },
  //     {
  ...
  //         description:
  //           "You can either use the zoom controls or scroll using your mouse!",
  //         position: "left",
  //       },
  //     },
  //     {
  ...
  //         description:
  //           "You can use the direction controls to move or just drag ",
  //         position: "left",
  //       },
  //     },
  //     {
  ...
  //         description:
  //           "you can either choose a point or draw a rectangle on the map!",
  //         position: "right",
  //       },
  //     },
  //   ]);
