        ...
        <Grid container spacing={2}>
          <Grid item sm={12} xs={12} md={6}>
              ...
              <form onSubmit={handleSubmit} sx={{ mt: 3, width: 1 }}>
                <Grid spacing={2}>
                  <div className="namecontainercontactus">
                    <div>
                      <p className="paragraphContactUsForm">First Name</p>
                      <TextField
                        name="firstName"
                        label="First Name"
                        variant="outlined"
                    ...
                    <div>
                      <p className="paragraphContactUsForm">Last Name</p>
                      <TextField
                        name="lastName"
                        label="Last Name"
                        variant="outlined"
            ...
            <Snackbar
              ...
              onClose={handleClose}
              message="Form Submitted! We will get back to you soon!"
              sx={{
          ...
          <Grid item sm={12} xs={12} md={6}>
            <div className="containercontactusmap">
              <iframe
                className="mapcontactus"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55361.61383732285!2d77.85980628345146!3d29.86136482885714!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb36e08b35119%3A0x798f5dc25ebd0a72!2sRoorkee%2C%20Uttarakhand!5e0!3m2!1sen!2sin!4v1678011419394!5m2!1sen!2sin"
                allowfullscreen=""
                loading="lazy"
